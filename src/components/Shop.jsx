...
const Header = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setShowContent1(prevShowContent1 => !prevShowContent1);
  ...
  return (
    <div className="container mx-auto pt-2">
      <div className="flex flex-col md:flex-row space-x-4">
        {/* Main Part */}
        <div className="carousel-container md:w-3/4">
          {showContent1 ? (
            <div className="bg-white shadow-sm rounded-lg p-2 mb-6 bg-cover md:w-full">
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="text-center md:text-left md:w-3/4 pl-10">
                  <h1 className="text-5xl font-bold pb-6">
                    ...
                    <span className="relative inline-block pb-4">
                      ...
                      <span className="absolute top-0 left-0 w-full h-full bg-yellow-500 transform skew-x-6 -rotate-2 z-0"></span>
                    </span> CLOTHES.
                  </h1>
                ...
                <div className="md:w-1/3 pb-6">
                  <img src={bannerImage1} alt="Banner" className="w-full rounded-lg h-60 bg-cover" />
                </div>
              </div>
            </div>
          ) : (
              ...
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="text-center md:text-left md:w-3/4 pl-10">
                  <h1 className="text-5xl font-bold pb-6">
                    DISCOVER & FIND <br />
                    <span className="relative inline-block pb-4">
                      YOUR <span className="relative z-10 pb-4">OWN</span>
                      <span className="absolute top-0 left-0 w-full h-full bg-purple-500 transform skew-x-6 -rotate-2 z-0"></span>
                    </span> FASHION!
                  </h1>
                  <p className="pb-6 text-xl">Explore our curated collection of stylish clothing and accessories tailored to your unique taste.</p>
                  <button className="bg-black text-white py-2 px-4 rounded inline-flex items-center">
                    Explore Now <span className="ml-2"><RiShoppingCartFill /></span>
                  </button>
                </div>
                <div className="md:w-1/3 pb-6">
                  <img src={bannerImage2} alt="Banner" className="w-full rounded-lg h-60 bg-cover" />
                </div>
              </div>
            </div>
          )}
        ...
        <div className="md:w-1/4">
          <div className="bg-blue-400 shadow-sm rounded-lg bg-cover p-4">
            ...
            <div className="flex items-center justify-center space-x-2">
              <img src={Image4} alt="Promotion 1" className="w-20 h-20 rounded-lg mt-2" />
              <img src={Image5} alt="Promotion 2" className="w-20 h-20 rounded-lg mt-2" />
            </div>
