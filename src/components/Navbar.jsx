...
const Navbar = () => {
  ...
  const handleNavigation = (path) => {
    navigate(path);
    setNav(false); // Close the nav menu if open
  };
      ...
      <div className='font-poppins hidden md:flex'>
        ...
        <ul className='hidden md:flex space-x-6'>
          <li className='uppercase text-sm'>
            <button onClick={() => handleNavigation('/')} className='hover:text-blue-500 hover:scale-125 transition-transform duration-200'>SHOP</button>
          </li>
          <li className='uppercase text-sm'>
            <button onClick={() => handleNavigation('/men')} className='hover:text-blue-500 hover:scale-125 transition-transform duration-200'>MEN</button>
          </li>
          <li className='uppercase text-sm'>
            <button onClick={() => handleNavigation('/women')} className='hover:text-blue-500 hover:scale-125 transition-transform duration-200'>WOMEN</button>
          </li>
          <li className='uppercase text-sm'>
            <button onClick={() => handleNavigation('/kids')} className='hover:text-blue-500 hover:scale-125 transition-transform duration-200'>KIDS</button>
          </li>
          <li className='uppercase text-sm'>
            <button onClick={() => handleNavigation('/contact')} className='hover:text-blue-500 hover:scale-125 transition-transform duration-200'>CONTACT US</button>
          </li>
        </ul>
      </div>
