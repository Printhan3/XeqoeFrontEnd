...
const NewArrivals = () => {
  const products = [
    {
      ...
      image: Rectangle25, // Correct way to import image
    ...
    },
    {
      id: 1,
      name: 'White T-Shirt',
      image: Rectangle26, // Correct way to import image
      brand: "Helen’s Brand",
      rating: 4.9,
      price: 12.00,
      salePrice: 20.99,
    },
    {
      ...
      image: Rectangle27, // Correct way to import image
      brand: "Jhanvi's Brand",
      rating: 4.9,
      price: 123.00,
      salePrice: 199.99,
    },
    {
      id: 1,
      name: 'Levender Hoodie',
      image: Rectangle28, // Correct way to import image
      brand: "Jhanvi's Brand",
      rating: 4.9,
      price: 123.00,
      salePrice: 199.99,
  ...
  return (
    ...
    <div className="bg-gray-100 py-4 px-10 relative">
     ...
     <div className='flex items-center space-x-2'> 
      ...
      <button
          className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md w-8 h-8 flex items-center justify-center"
          onClick={handlePrev}
        >
    ...
    <button
        className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md w-8 h-8 flex items-center justify-center"
        onClick={handleNext}
      >
...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="flex flex-col rounded-lg shadow-md bg-white overflow-hidden relative">
      <img className="w-full h-88 object-cover" src={image} alt={name}/>
      <button
          onClick={handleLike}
          className={`absolute top-3 right-3 border rounded-full w-8 h-8 bg-white ${liked ? 'text-red-500' : 'text-blue-500'}`}
        >
          <FontAwesomeIcon icon={liked ? faHeartSolid : faHeartRegular} className="w-4 h-4  " />
        </button> 
